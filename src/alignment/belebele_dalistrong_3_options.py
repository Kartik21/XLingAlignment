...
def load_worst_wrong_answer(args):
    worst_choice = []
    ...
    for i in range(900):
        ...
        worst_choice.append(min(wrong_choices, key=lambda x: log_prob[x - 1]))
    return worst_choice



def compute_alignment(args, worst_choice):
    ...
    for layer in range(32):
        for idx in range(900):
            ...
            if worst_choice[idx] == 1:
                'remove all similaries associated with 1'
                max_non_aligned_lasttoken = max(cs_23_lasttoken,cs_32_lasttoken,cs_24_lasttoken,cs_42_lasttoken,cs_34_lasttoken,cs_43_lasttoken,
                                                cs_23_lasttoken_within_eng,cs_23_lasttoken_within_lang,cs_24_lasttoken_within_lang,cs_24_lasttoken_within_eng,cs_34_lasttoken_within_eng,cs_34_lasttoken_within_lang)
                if (cs_22_lasttoken > max_non_aligned_lasttoken) & (cs_33_lasttoken > max_non_aligned_lasttoken) & (cs_44_lasttoken > max_non_aligned_lasttoken):
                    binary_alignment_matrix_lasttoken[idx][layer] = 1
                else:
                    binary_alignment_matrix_lasttoken[idx][layer] = 0
            if worst_choice[idx] == 2:
                max_non_aligned_lasttoken = max(cs_13_lasttoken,cs_31_lasttoken,cs_14_lasttoken,cs_41_lasttoken,cs_34_lasttoken,cs_43_lasttoken,
                                                cs_13_lasttoken_within_eng,cs_13_lasttoken_within_lang,cs_14_lasttoken_within_eng,cs_14_lasttoken_within_lang,cs_34_lasttoken_within_eng, cs_14_lasttoken_within_lang)
                if (cs_11_lasttoken > max_non_aligned_lasttoken) & (cs_33_lasttoken > max_non_aligned_lasttoken) & (cs_44_lasttoken > max_non_aligned_lasttoken):
                    binary_alignment_matrix_lasttoken[idx][layer] = 1
                else:
                    binary_alignment_matrix_lasttoken[idx][layer] = 0

            if worst_choice[idx] == 3:
                max_non_aligned_lasttoken = max(cs_12_lasttoken,cs_21_lasttoken,cs_14_lasttoken,cs_41_lasttoken,cs_24_lasttoken,cs_42_lasttoken,
                                                cs_12_lasttoken_within_eng,cs_12_lasttoken_within_lang, cs_14_lasttoken_within_eng, cs_14_lasttoken_within_lang, cs_24_lasttoken_within_eng,cs_24_lasttoken_within_lang)
                if (cs_11_lasttoken > max_non_aligned_lasttoken) & (cs_22_lasttoken > max_non_aligned_lasttoken) & (cs_44_lasttoken > max_non_aligned_lasttoken):
                    binary_alignment_matrix_lasttoken[idx][layer] = 1
                else:
                    binary_alignment_matrix_lasttoken[idx][layer] = 0

            if worst_choice[idx] == 4:
                max_non_aligned_lasttoken = max(cs_12_lasttoken,cs_21_lasttoken,cs_13_lasttoken,cs_21_lasttoken,cs_23_lasttoken,cs_32_lasttoken,
                                                cs_12_lasttoken_within_eng,cs_12_lasttoken_within_lang,cs_13_lasttoken_within_eng,cs_13_lasttoken_within_lang,cs_23_lasttoken_within_eng,cs_23_lasttoken_within_lang)
                if (cs_11_lasttoken > max_non_aligned_lasttoken) & (cs_22_lasttoken > max_non_aligned_lasttoken) & (cs_33_lasttoken > max_non_aligned_lasttoken):
                    binary_alignment_matrix_lasttoken[idx][layer] = 1
                else:
                    binary_alignment_matrix_lasttoken[idx][layer] = 0
...
if __name__ == '__main__':
     ...
     parser.add_argument('--save_path', type=str, default='../alignment_outputs/Llama3.1/belebele_dalistrong_3option/')
     parser.add_argument('--embedding_path', type=str,default='/fs/nexus-scratch/kravisan/embeddings/Llama3.1/belebele_dali/')
     args = parser.parse_args()
     worst_choice_to_eliminate = load_worst_wrong_answer(args)
