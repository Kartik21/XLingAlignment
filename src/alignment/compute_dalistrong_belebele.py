...
def compute_alignment(args):
    ...
    for layer in range(32):
        for idx in range(900):
            ...
            max_non_aligned_lasttoken = max(cs_12_lasttoken,cs_21_lasttoken,cs_13_lasttoken,cs_31_lasttoken,cs_14_lasttoken,cs_41_lasttoken,cs_23_lasttoken,cs_32_lasttoken,cs_24_lasttoken,cs_42_lasttoken,cs_34_lasttoken,cs_43_lasttoken, cs_12_lasttoken_within_eng,cs_13_lasttoken_within_eng,cs_14_lasttoken_within_eng,cs_23_lasttoken_within_eng,cs_24_lasttoken_within_eng,cs_34_lasttoken_within_eng,cs_12_lasttoken_within_lang,cs_13_lasttoken_within_lang,cs_14_lasttoken_within_lang,cs_23_lasttoken_within_lang,cs_24_lasttoken_within_lang,cs_34_lasttoken_within_lang)
...
if __name__ == '__main__':
     ...
     parser.add_argument('--save_path', type=str, default='../alignment_outputs/Llama3.1/belebele_dali_strong/')
