...
def compute_alignment(args):
    ...
    for layer in range(32):
        for idx in range(1511):
            ...
            cs_12_lasttoken = cosine_similarity(lang_choice1_formatted_lasttoken[layer][idx+1], english_choice2_formatted_lasttoken[layer][idx+1])
            cs_21_lasttoken = cosine_similarity(lang_choice2_formatted_lasttoken[layer][idx+1], english_choice1_formatted_lasttoken[layer][idx+1])
...
if __name__ == '__main__':
     ...
     parser.add_argument('--save_path', type=str, default='../../alignment_outputs/Llama3.1/xstorycloze_dali_strong/')
