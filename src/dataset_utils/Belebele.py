...
class BELEBELE(AbstractDataset):
    def __init__(self):
    ...
    def get_dataset(self, args, lang):
        ...
        dataset = load_dataset('Kartik221/Belebele_test', lang, trust_remote_code=True)
        dataset = dataset[args.strata]
        data = []
        key = []
        for i in range(len(dataset)):
            data.append(dataset[i][args.input_field])
            key.append((dataset[i]['link'],dataset[i]['question_number']))
        return data, key
