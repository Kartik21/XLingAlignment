...
if __name__ == '__main__':
    ...
    parser.add_argument('--combination_approach', type = str, default = "separate_inputs", help="Choose between concatenation or separate_inputs; Not used for FLORES dataset")    
    ...
    parser.add_argument('--quantize_4bit', type = bool, default = True, help="Choose ifm you want 4 bit quantization")
