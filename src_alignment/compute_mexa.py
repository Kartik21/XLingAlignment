...
def compute_distance(lang, embedding_type='embd_lasttoken', num_sents=100):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pivot', type=str, help='Pivot language code (e.g., eng_Latn)')
    parser.add_argument('--file_ext', type=str, help='File extension for embedding files (e.g., .pkl)')
    ...
    parser.add_argument('--num_sents', type=int, help='Maximum number of sentences to process')
    parser.add_argument('--embedding_type', type=str, choices=['embd_lasttoken'], help='Type of embedding to use')
    parser.add_argument('--dataset', type=str, required=False, help='Dataset: xstorycloze, xcopa, or belebele')
    parser.add_argument('--lang', type=str, required=False, help='Language code (required for xcopa)')
