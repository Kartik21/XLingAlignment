...
def compute_alignment(args):
    ...
    print(f'DALI completed for lang: {args.lang}')
...
if __name__ == '__main__':
     ...
     parser.add_argument('--save_path', type=str, help='Path to save alignment results')
     parser.add_argument('--embedding_path', type=str, help='Path to embedding files')
